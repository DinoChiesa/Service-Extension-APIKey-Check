...
/**
 * SslUtils provides utility methods for handling SSL contexts and reading SSL certificate and key
 * files.
 */
public class SslUtils {
  ...
  public static SslContext createSslContext(byte[] certBytes, byte[] keyBytes) throws SSLException {
    return GrpcSslContexts.forServer(
            new ByteArrayInputStream(certBytes), new ByteArrayInputStream(keyBytes))
        .build();
  }
}
