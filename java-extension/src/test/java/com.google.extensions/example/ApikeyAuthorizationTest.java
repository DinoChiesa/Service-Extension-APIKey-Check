...
public class ApikeyAuthorizationTest {
  ...
  private ApikeyAuthorization server;

  @Before
  public void setUp() throws IOException {
    server = new ApikeyAuthorization.Builder().setPort(8443).setHealthCheckPort(8000).build();
  ...
  @Test
  public void testBuildImmediateResponse() {
            ...
            HeaderValueOption.newBuilder()
                .setHeader(
                    HeaderValue.newBuilder()
                        .setKey("Location")
                        .setRawValue(
                            ByteString.copyFromUtf8("http://service-extensions.com/redirect"))
                        .build())
                .build());
  }

  @Test
  public void testOnRequestHeaders_Returns401() {
